...
import JavaCLStuff.Alignment;
import JavaCLStuff.Array;
import JavaCLStuff.Bits;
import JavaCLStuff.Field;
import JavaCLStuff.Union;
...
class StructFieldDeclaration {
    ...
    private static StructFieldDeclaration fromMember(Member member) {
        ...
        field.desc.isCLong = isAnnotationPresent(JavaCLStuff.CLong.class, getter);
        field.desc.isSizeT = isAnnotationPresent(JavaCLStuff.Ptr.class, getter);
        return field;
    }
}
