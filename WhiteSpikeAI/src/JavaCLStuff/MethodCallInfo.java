...
import static JavaCLStuff.DyncallLibrary.DC_CALL_C_X86_WIN32_FAST_GNU;
import static JavaCLStuff.DyncallLibrary.DC_CALL_C_X86_WIN32_FAST_MS;
import static JavaCLStuff.DyncallLibrary.DC_CALL_C_X86_WIN32_STD;
import static JavaCLStuff.DyncallLibrary.DC_CALL_C_X86_WIN32_THIS_MS;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_BOOL;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_CC_FASTCALL_GNU;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_CC_FASTCALL_MS;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_CC_PREFIX;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_CC_STDCALL;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_CC_THISCALL_MS;
...
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_LONG;
...
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_STRUCT;
import static JavaCLStuff.DyncallLibrary.DC_SIGCHAR_VOID;
import static JavaCLStuff.AnnotationUtils.getAnnotation;
import static JavaCLStuff.AnnotationUtils.getInheritableAnnotation;
import static JavaCLStuff.AnnotationUtils.isAnnotationPresent;
...
import JavaCLStuff.NativeConstants.ValueType;
import JavaCLStuff.Constructor;
//import org.bridj.cpp.CPPObject;
import JavaCLStuff.Convention;
import JavaCLStuff.DisableDirect;
import JavaCLStuff.Ptr;
import JavaCLStuff.SetsLastError;
...
//            Options paramOptions = paramsOptions[iParam] = new Options();
    ...
    public ValueType getValueType(int iParam, int nParams, Class<?> c, Type t, AnnotatedElement element, Annotation... directAnnotations) {
        ...
        boolean isCLong = isAnnotationPresent(JavaCLStuff.CLong.class, element, directAnnotations);
